  ...
  return (
    <div className="bg-primary">
      <div className="grid grid-cols-5 grid-rows-[1fr,auto,88]">
        <aside
          className="col-span-5 md:col-span-1 md:sticky md:top-0 md:h-screen overflow-y-auto bg-primary text-white md:pb-[88px]"
        >
          <NavBar />
        </aside>
        <main
          className="col-span-5 md:col-span-4 grid grid-rows-[1fr,auto] pb-[88px]"
        >
      ...
      <div
        className="fixed z-40 bottom-0 left-0 right-0 transition-all ease-"
      >
        <Player />
      </div>
      {/* <AddToPlaylistModal />
